    ...
    <div className='py-5'>
      ...
      <div className='flex flex-col mx-auto mt-5 max-w-[85rem] px-[2rem]'>
        ...
        <div className='grid mx-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[1rem]'>
          <ProjectCard title="Web - Portfolio" desc="A small yet comprehensive website that serves as a portfolio for all of my works. It's a collective platform where I showcase my projects, skills, and achievements." url="https://github.com/K1EW/CEDT-Comprog" img="/images/webport-preview.png" />
